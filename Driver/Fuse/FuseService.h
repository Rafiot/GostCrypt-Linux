...
#ifndef GST_HEADER_Driver_Fuse_FuseService
#define GST_HEADER_Driver_Fuse_FuseService
...
namespace GostCrypt
{
	...
	public:
		...
		static string GetDeviceType () { return "gostcrypt"; }
...
#endif // GST_HEADER_Driver_Fuse_FuseService
