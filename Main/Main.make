...
RESOURCES += ../Format/GostCrypt_Wizard.bmp.h
...
GST_VERSION = $(shell grep VERSION_STRING ../Common/Gstdefs.h | head -n 1 | cut -d'"' -f 2)
...
ifeq "$(GST_BUILD_CONFIG)" "Release"
	...
	cp $(PWD)/Resources/Icons/GostCrypt.icns $(APPNAME).app/Contents/Resources
	
	echo -n APPLTRUE >$(APPNAME).app/Contents/PkgInfo
	sed -e 's/_VERSION_/$(patsubst %a,%.1,$(patsubst %b,%.2,$(GST_VERSION)))/' ../Build/Resources/MacOSX/Info.plist.xml >$(APPNAME).app/Contents/Info.plist
endif
