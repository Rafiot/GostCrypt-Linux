...
#ifndef GST_HEADER_Main_GraphicUserInterface
#define GST_HEADER_Main_GraphicUserInterface
...
namespace GostCrypt
{
	...
	DECLARE_EVENT_TYPE (GST_EVENT_THREAD_EXITING, -1);

	extern GraphicUserInterface *Gui;
}

#endif // GST_HEADER_Main_GraphicUserInterface
