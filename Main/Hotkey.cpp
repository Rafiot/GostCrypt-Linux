...
#define GST_HOTKEY(ID,LANG) hotkeys.push_back (shared_ptr <Hotkey> (new Hotkey (Id::##ID, L###ID, LangString[LANG])))

		GST_HOTKEY (CloseAllSecurityTokenSessions, "IDM_CLOSE_ALL_TOKEN_SESSIONS");
		GST_HOTKEY (DismountAll, "HK_DISMOUNT_ALL");
		GST_HOTKEY (DismountAllWipeCache, "HK_DISMOUNT_ALL_AND_WIPE");
		GST_HOTKEY (ForceDismountAllWipeCache, "HK_FORCE_DISMOUNT_ALL_AND_WIPE");
		GST_HOTKEY (ForceDismountAllWipeCacheExit, "HK_FORCE_DISMOUNT_ALL_AND_WIPE_AND_EXIT");
		GST_HOTKEY (MountAllDevices, "HK_AUTOMOUNT_DEVICES");
		GST_HOTKEY (MountAllFavorites, "HK_MOUNT_FAVORITE_VOLUMES");
		GST_HOTKEY (ShowHideApplication, "HK_SHOW_HIDE_MAIN_WINDOW");
		GST_HOTKEY (WipeCache, "HK_WIPE_CACHE");
