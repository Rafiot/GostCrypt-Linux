...
#ifndef GST_HEADER_Main_Forms_VolumeCreationProgressWizardPage
#define GST_HEADER_Main_Forms_VolumeCreationProgressWizardPage
...
#endif // GST_HEADER_Main_Forms_VolumeCreationProgressWizardPage
