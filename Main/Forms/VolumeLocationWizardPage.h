...
#ifndef GST_HEADER_Main_Forms_VolumeLocationWizardPage
#define GST_HEADER_Main_Forms_VolumeLocationWizardPage
...
#endif // GST_HEADER_Main_Forms_VolumeLocationWizardPage
