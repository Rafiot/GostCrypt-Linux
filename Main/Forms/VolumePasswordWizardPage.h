...
#ifndef GST_HEADER_Main_Forms_VolumePasswordWizardPage
#define GST_HEADER_Main_Forms_VolumePasswordWizardPage
...
#endif // GST_HEADER_Main_Forms_VolumePasswordWizardPage
