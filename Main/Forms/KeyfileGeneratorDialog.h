...
#ifndef GST_HEADER_Main_Forms_KeyfileGeneratorDialog
#define GST_HEADER_Main_Forms_KeyfileGeneratorDialog
...
#endif // GST_HEADER_Main_Forms_KeyfileGeneratorDialog
