...
#ifndef GST_HEADER_Main_Forms_NewSecurityTokenKeyfileDialog
#define GST_HEADER_Main_Forms_NewSecurityTokenKeyfileDialog
...
#endif // GST_HEADER_Main_Forms_NewSecurityTokenKeyfileDialog
