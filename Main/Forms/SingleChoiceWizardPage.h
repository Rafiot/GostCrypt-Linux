...
#ifndef GST_HEADER_Main_Forms_SingleChoiceWizardPage
#define GST_HEADER_Main_Forms_SingleChoiceWizardPage
...
#endif // GST_HEADER_Main_Forms_SingleChoiceWizardPage
