...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	WebsiteMenuItem = new wxMenuItem( HelpMenu, wxID_ANY, wxString( _("GostCrypt Website") ) , wxEmptyString, wxITEM_NORMAL );
...
PreferencesDialogBase::PreferencesDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	WipeCacheOnCloseCheckBox = new wxCheckBox( SecurityPage, wxID_ANY, _("Wipe after GostCrypt window has been closed"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer18 = new wxStaticBoxSizer( new wxStaticBox( BackgroundTaskPanel, wxID_ANY, _("GostCrypt Background Task") ), wxVERTICAL );
	...
	StartOnLogonCheckBox = new wxCheckBox( SystemIntegrationPage, wxID_ANY, _("Start GostCrypt Background Task"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	MountDevicesOnLogonCheckBox = new wxCheckBox( SystemIntegrationPage, wxID_ANY, _("Mount all device-hosted GostCrypt volumes"), wxDefaultPosition, wxDefaultSize, 0 );
